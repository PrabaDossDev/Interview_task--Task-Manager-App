...
class _DialogManagerState extends State<DialogManager> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      // //  if (locator<EnvironmentService>().environment == "DEV")
      //     DraggableFab(
              ...
              content: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(request.title  ?? '', textScaleFactor: 1, style: AppTextStyle.body1SemiBold,),

                    VerticalSpacing.d20px(),

                    Text(request.description  ?? '', textAlign: TextAlign.center, textScaleFactor: 1, style: AppTextStyle.body1SemiBold,),
                      ...
                      Expanded(
                          child: request.title == null ? Container() : Padding(
                            ...
                            child: Text(request.title ?? '', textScaleFactor: 1,
                              style: AppTextStyle.body1SemiBold.copyWith(fontSize: 17,),
                            ),
                          )
                      ),
